...
RestaurantDetailModel _$RestaurantDetailModelFromJson(
    ...
    RestaurantDetailModel(
      ...
      priceRange: $enumDecode(_$RestaurantRangeEnumMap, json['priceRange']),
...
Map<String, dynamic> _$RestaurantDetailModelToJson(
    ...
    <String, dynamic>{
      ...
      'tags': instance.tags,
      'priceRange': _$RestaurantRangeEnumMap[instance.priceRange]!,
...
const _$RestaurantRangeEnumMap = {
  RestaurantRange.expensive: 'expensive',
  RestaurantRange.medium: 'medium',
  RestaurantRange.cheap: 'cheap',
};
